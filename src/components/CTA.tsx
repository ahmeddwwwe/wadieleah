    ...
    <div className="container relative text-center">
      <div className="reveal max-w-2xl mx-auto">
        ...
        <h2 className="text-4xl md:text-6xl font-black text-frost leading-tight">
          جاهز <span className="text-gradient-aurora">للمغامرة؟</span>
        </h2>
        <p className="mt-5 text-lg text-muted-foreground leading-relaxed">
          احجز الآن واستمتع بتجربة ثلجية لا تُنسى في وادي الراحة
        </p>
        ...
        <div className="mt-8 flex items-center justify-center gap-4 flex-wrap">
          ...
          <span className="text-sm text-muted-foreground">+١٢٠ شخص حجزوا هذا الشهر</span>
        </div>
